...
<table class="table table-bordered" style="border-collapse: collapse">
    <tr class="thead-dark">
        <?php $columnas = ["Num Vendedor","Nombre Vendedor","Nombre Comercio","Teléfono","Calle","Ciudad","Provincia"];
    ...
    foreach ($consulta as $fila){
        ...
        <?php } ?>
            ...
            <td class="campos">
                <a href="controladores/modificar.php?id=<?=$fila['numvend']?>" class="btn btn-primary mr-1" ><i class="fa-solid fa-pen-to-square"></i></a>
